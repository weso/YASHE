module.exports = {table:
{
  ...
  "[or([tripleConstraint,bracketedTripleExpr])]" : {
     "(": ["or([tripleConstraint,bracketedTripleExpr])"], 
     "a": ["or([tripleConstraint,bracketedTripleExpr])"], 
     "^": ["or([tripleConstraint,bracketedTripleExpr])"], 
     "IRI_REF": ["or([tripleConstraint,bracketedTripleExpr])"], 
     "PNAME_LN": ["or([tripleConstraint,bracketedTripleExpr])"], 
     "PNAME_NS": ["or([tripleConstraint,bracketedTripleExpr])"]}, 
  "[string,?[^^,datatype]]" : {
  ...
  "or([PNAME_LN,PNAME_NS])" : {
     "PNAME_LN": ["PNAME_LN"], 
     "PNAME_NS": ["PNAME_NS"]}, 
  "or([[or([tripleConstraint,bracketedTripleExpr])],include])" : {
     "(": ["[or([tripleConstraint,bracketedTripleExpr])]"], 
     "a": ["[or([tripleConstraint,bracketedTripleExpr])]"], 
     "^": ["[or([tripleConstraint,bracketedTripleExpr])]"], 
     "IRI_REF": ["[or([tripleConstraint,bracketedTripleExpr])]"], 
  ...
  "unaryTripleExpr" : {
     "(": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "&": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "a": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "^": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "IRI_REF": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "PNAME_LN": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "PNAME_NS": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"], 
     "$": ["?[$,tripleExprLabel]","or([[or([tripleConstraint,bracketedTripleExpr])],include])"]}, 
  "valueSet" : {
     "[": ["[","*valueSetValue","]"]}, 
  "valueSetValue" : {
