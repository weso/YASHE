module.exports = {table:
{
  ...
  "*languajeExclusion" : {
     ...
     "]": []}, 
  "*literalExclusion" : {
     "literalExclusion": ["literalExclusion","*literalExclusion"], 
     ".": [], 
     "LANGTAG": [], 
     "@": [], 
     "IRI_REF": [], 
...
keywords:/^(BASE|PREFIX|IMPORT|EXTERNAL|OR|AND|NOT|LITERAL|NONLITERAL|IRI|BNODE|LENGTH|MINLENGTH|MAXLENGTH|MININCLUSIVE|MINEXCLUSIVE|MAXINCLUSIVE|MAXEXCLUSIVE|TOTALDIGITS|FRACTIONDIGITS|CLOSED|EXTRA|TRUE|FALSE|START|A)/i ,
