module.exports = {table:
{
  ...
  "*qualifier" : {
     ...
     "EXTENDS": ["qualifier","*qualifier"], 
     "&": ["qualifier","*qualifier"], 
     "RESTRICTS": ["qualifier","*qualifier"], 
     "-": ["qualifier","*qualifier"], 
     "EXTRA": ["qualifier","*qualifier"], 
     "{": []}, 
  "*shapeRef" : {
     "ATPNAME_NS": ["shapeRef","*shapeRef"], 
     "ATPNAME_LN": ["shapeRef","*shapeRef"], 
     "@": ["shapeRef","*shapeRef"], 
     "CLOSED": [], 
     "EXTENDS": [], 
     "&": [], 
  ...
  "*statement" : {
     ...
     "KW_ABSTRACT": ["statement","*statement"], 
  ...
  "?[or([notStartAction,startActions]),*statement]" : {
     ...
     "KW_ABSTRACT": ["[or([notStartAction,startActions]),*statement]"], 
     "%": ["[or([notStartAction,startActions]),*statement]"], 
  ...
  "?inlineShapeOrRef" : {
     ...
     "EXTENDS": ["inlineShapeOrRef"], 
     "&": ["inlineShapeOrRef"], 
     "RESTRICTS": ["inlineShapeOrRef"], 
     "-": ["inlineShapeOrRef"], 
  ...
  "inlineShapeAnd" : {
     ...
     "EXTENDS": ["inlineShapeNot","*[AND_TOKEN,inlineShapeNot]"], 
     "&": ["inlineShapeNot","*[AND_TOKEN,inlineShapeNot]"], 
     "RESTRICTS": ["inlineShapeNot","*[AND_TOKEN,inlineShapeNot]"], 
     "-": ["inlineShapeNot","*[AND_TOKEN,inlineShapeNot]"], 
  ...
  "inlineShapeAtom" : {
     ...
     "EXTENDS": ["inlineShapeOrRef","?nodeConstraint"], 
     "&": ["inlineShapeOrRef","?nodeConstraint"], 
     "RESTRICTS": ["inlineShapeOrRef","?nodeConstraint"], 
     "-": ["inlineShapeOrRef","?nodeConstraint"], 
  ...
  "inlineShapeDefinition" : {
     ...
     "CLOSED": ["*qualifier","{","?tripleExpression","}"], 
     "EXTENDS": ["*qualifier","{","?tripleExpression","}"], 
     "&": ["*qualifier","{","?tripleExpression","}"], 
     "RESTRICTS": ["*qualifier","{","?tripleExpression","}"], 
     "-": ["*qualifier","{","?tripleExpression","}"], 
     "EXTRA": ["*qualifier","{","?tripleExpression","}"]}, 
  "inlineShapeExpression" : {
     ...
     "EXTENDS": ["inlineShapeOr"], 
     "&": ["inlineShapeOr"], 
     "RESTRICTS": ["inlineShapeOr"], 
     "-": ["inlineShapeOr"], 
     "EXTRA": ["inlineShapeOr"]}, 
  "inlineShapeNot" : {
     "(": ["?NOT","inlineShapeAtom"], 
     ...
     "EXTENDS": ["?NOT","inlineShapeAtom"], 
     "&": ["?NOT","inlineShapeAtom"], 
     "RESTRICTS": ["?NOT","inlineShapeAtom"], 
     "-": ["?NOT","inlineShapeAtom"], 
  ...
  "inlineShapeOr" : {
     ...
     "EXTENDS": ["inlineShapeAnd","*[OR,inlineShapeAnd]"], 
     "&": ["inlineShapeAnd","*[OR,inlineShapeAnd]"], 
     "RESTRICTS": ["inlineShapeAnd","*[OR,inlineShapeAnd]"], 
     "-": ["inlineShapeAnd","*[OR,inlineShapeAnd]"], 
     "EXTRA": ["inlineShapeAnd","*[OR,inlineShapeAnd]"]}, 
  "inlineShapeOrRef" : {
     "{": ["inlineShapeDefinition"], 
     "CLOSED": ["inlineShapeDefinition"], 
     "EXTENDS": ["inlineShapeDefinition"], 
     "&": ["inlineShapeDefinition"], 
     "RESTRICTS": ["inlineShapeDefinition"], 
     "-": ["inlineShapeDefinition"], 
  ...
  "notStartAction" : {
     ...
     "KW_ABSTRACT": ["or([startt,shapeExprDecl])"], 
  ...
  "or([shapeExpression,EXTERNAL])" : {
     ...
     "&": ["shapeExpression"], 
     "RESTRICTS": ["shapeExpression"], 
     "-": ["shapeExpression"], 
     "EXTRA": ["shapeExpression"], 
     "EXTERNAL": ["EXTERNAL"]}, 
  "or([startt,shapeExprDecl])" : {
     "START": ["startt"], 
     "KW_ABSTRACT": ["shapeExprDecl"], 
  ...
  "qualifier" : {
     "CLOSED": ["or([extension,restriction,extraPropertySet,CLOSED])"], 
     "EXTENDS": ["or([extension,restriction,extraPropertySet,CLOSED])"], 
     "&": ["or([extension,restriction,extraPropertySet,CLOSED])"], 
     "RESTRICTS": ["or([extension,restriction,extraPropertySet,CLOSED])"], 
     "-": ["or([extension,restriction,extraPropertySet,CLOSED])"], 
     "EXTRA": ["or([extension,restriction,extraPropertySet,CLOSED])"]}, 
  "rdfLit" : {
     "LANGTAG": ["LANGTAG"], 
     "^": ["^","^","datatype"], 
     ".": [], 
     ...
     "$": []}, 
  "rdfLiteral" : {
     "STRING_LITERAL1": ["string","rdfLit"], 
     "STRING_LITERAL_LONG1": ["string","rdfLit"], 
     "STRING_LITERAL2": ["string","rdfLit"], 
     "STRING_LITERAL_LONG2": ["string","rdfLit"]}, 
  "restriction" : {
     "RESTRICTS": ["RESTRICTS","shapeRef"], 
     "-": ["-","shapeRef"]}, 
  "semanticActions" : {
     "%": ["*codeDecl"], 
     "OR": ["*codeDecl"], 
  ...
  "shapeAnd" : {
     ...
     "EXTENDS": ["shapeNot","*[AND_TOKEN,shapeNot]"], 
     "&": ["shapeNot","*[AND_TOKEN,shapeNot]"], 
     "RESTRICTS": ["shapeNot","*[AND_TOKEN,shapeNot]"], 
     "-": ["shapeNot","*[AND_TOKEN,shapeNot]"], 
  ...
  "shapeAtom" : {
     ...
     ".": ["."]}, 
  "shapeDefinition" : {
     "{": ["inlineShapeDefinition","*annotation","semanticActions"], 
     "CLOSED": ["inlineShapeDefinition","*annotation","semanticActions"], 
     "EXTENDS": ["inlineShapeDefinition","*annotation","semanticActions"], 
     "&": ["inlineShapeDefinition","*annotation","semanticActions"], 
     "RESTRICTS": ["inlineShapeDefinition","*annotation","semanticActions"], 
     "-": ["inlineShapeDefinition","*annotation","semanticActions"], 
     "EXTRA": ["inlineShapeDefinition","*annotation","semanticActions"]}, 
  "shapeExprDecl" : {
     "IRI_REF": ["?KW_ABSTRACT","shapeExprLabel","or([shapeExpression,EXTERNAL])"], 
     "BLANK_NODE_LABEL": ["?KW_ABSTRACT","shapeExprLabel","or([shapeExpression,EXTERNAL])"], 
     "PNAME_LN": ["?KW_ABSTRACT","shapeExprLabel","or([shapeExpression,EXTERNAL])"], 
     "PNAME_NS": ["?KW_ABSTRACT","shapeExprLabel","or([shapeExpression,EXTERNAL])"], 
     "KW_ABSTRACT": ["?KW_ABSTRACT","shapeExprLabel","or([shapeExpression,EXTERNAL])"]}, 
  "shapeExprLabel" : {
  ...
  "shapeNot" : {
     ...
     "EXTENDS": ["?NOT","shapeAtom"], 
     "&": ["?NOT","shapeAtom"], 
     "RESTRICTS": ["?NOT","shapeAtom"], 
     "-": ["?NOT","shapeAtom"], 
     "EXTRA": ["?NOT","shapeAtom"], 
     "NOT": ["?NOT","shapeAtom"]}, 
  "shapeOr" : {
     ...
     "EXTENDS": ["shapeAnd","*[OR,shapeAnd]"], 
     "&": ["shapeAnd","*[OR,shapeAnd]"], 
     "RESTRICTS": ["shapeAnd","*[OR,shapeAnd]"], 
     "-": ["shapeAnd","*[OR,shapeAnd]"], 
  ...
  "shapeOrRef" : {
     ...
     "EXTENDS": ["or([shapeDefinition,shapeRef])"], 
     "&": ["or([shapeDefinition,shapeRef])"], 
     "RESTRICTS": ["or([shapeDefinition,shapeRef])"], 
     "-": ["or([shapeDefinition,shapeRef])"], 
  ...
  "shexDoC" : {
     ...
     "KW_ABSTRACT": ["*directive","?[or([notStartAction,startActions]),*statement]","$"], 
     "%": ["*directive","?[or([notStartAction,startActions]),*statement]","$"], 
  ...
  "statement" : {
     ...
     "KW_ABSTRACT": ["or([directive,notStartAction])"], 
...
keywords:/^(RESTRICTS|EXTENDS|BASE|PREFIX|IMPORT|EXTERNAL|OR|NOT|LITERAL|NONLITERAL|IRI|BNODE|LENGTH|MINLENGTH|MAXLENGTH|MININCLUSIVE|MINEXCLUSIVE|MAXINCLUSIVE|MAXEXCLUSIVE|TOTALDIGITS|FRACTIONDIGITS|CLOSED|EXTRA|TRUE|FALSE|START)/i ,
