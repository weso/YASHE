...
CodeMirror.defineMode("shex", function(config, parserConfig) {
 ...
 var BNODE  ="BNODE"
 var NONLITERAL = "NONLITERAL"
 var LENGTH = "LENGTH"
 var MINLENGTH = "MINLENGTH"
 var MAXLENGTH = "MAXLENGTH"
 var MININCLUSIVE = "MININCLUSIVE"
 var MINEXCLUSIVE = "MINEXCLUSIVE"
 var MAXINCLUSIVE = "MAXINCLUSIVE"
 var MAXEXCLUSIVE = "MAXEXCLUSIVE"
 var TOTALDIGITS = "TOTALDIGITS"
  ...
  */
  ...
  var terminals = [
    ...
    {
      name: "LITERAL",
      regex: new RegExp("^" + LITERAL),
      style: "directive"
    },

    {
      name: "BNODE",
      regex: new RegExp("^" + BNODE),
      style: "directive"
    },

    {
      name: "NONLITERAL",
      regex: new RegExp("^" + NONLITERAL),
      style: "directive"
    },
    ...
    {
      name: "MININCLUSIVE",
      regex: new RegExp("^" + MININCLUSIVE),
      style: "directive"
    },

    {
      name: "MINEXCLUSIVE",
      regex: new RegExp("^" + MINEXCLUSIVE),
      style: "directive"
    },

    {
      name: "MAXINCLUSIVE",
      regex: new RegExp("^" + MAXINCLUSIVE),
      style: "directive"
    },

    {
      name: "MAXEXCLUSIVE",
      regex: new RegExp("^" + MAXEXCLUSIVE),
      style: "directive"
    },

    {
      name: "TOTALDIGITS",
      regex: new RegExp("^" + TOTALDIGITS),
      style: "directive"
    },

    {
      name: "FRACTIONDIGITS",
      regex: new RegExp("^" + FRACTIONDIGITS),
      style: "directive"
    },

    {
      name: "CLOSED",
      regex: new RegExp("^" + CLOSED),
      style: "directive"
    },
    ...
    function nextToken() {
      ...
      for (var i = 0; i < terminals.length; ++i) {
        ...
        if (consumed) {
          ...
          console.log(stream.current().includes(":"))
...
CodeMirror.defineMIME("application/x-shex-query", "shex");
